    ...
    return (
        <div className="container-main-component">
            <div className="main-component-left">
                ...
                <h1 className="temp-info">{weatherInfo?.main.temp + ' *F'}</h1>
            ...
            <div className="main-component-right">
                <div className="wrapper-info1">
                    ...
                    <div className="">
                        ...
                        <p className = "value-info">{weatherInfo?.main.feels_like + ' *F'}</p>
                    </div>
                </div>
                ...
                <div className="wrapper-info4">
                    ...
                    <div className="">
                        ...
                        <p className = "value-info">{weatherInfo?.wind.speed + ' Km/Hr'}</p>
                    </div>
                </div>
            </div>
        </div>
