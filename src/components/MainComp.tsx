...
function MainComp() {
    ...
    function handleBtnClick(): void {
        // gaEventTracker('call');
        ReactGA.event({'category':'Test', 'action':'click', 'label' : 'label'});
    ...
    return (
        <div className="container-main-component" ref={containerRef}>
            <div className="main-component-left">
                ...
                <p className="time-info">{`Friday, 23rd Jun '23 3:08 pm`}</p>
                <h1 className="temp-info">{Math.round(weatherInfo?.main.temp - 273.15)} &deg;C</h1>
                <button className="switch-btn">Display *F</button>
                <svg className="cloud-svg" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="#f5f5f5" viewBox="0 6 32 20">
                    <title>cloud</title>
                ...
                <div className="container-search">
                    <input value={userInput} type="text" placeholder="Surat..." onChange={handleInputChange} onKeyPress={event => {
                        if (event.key === 'Enter') {
                            handleBtnClick();
                        }
                    }} />
            ...
            <div className="main-component-right">
                ...
                <div className="wrapper-info4">
                    ...
                    <div className="">
                        <p className="value-text">Wind Speed</p>
                        <p className="value-info">{Math.round(weatherInfo?.wind.speed * 1.60934) + ' Km/Hr'}</p>
                    </div>
                </div>
            </div>
        </div>
